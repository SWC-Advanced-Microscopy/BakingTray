...
%
%    ButtonName = questdlgchckbox(Question, Title)
%
...
%  default Button:
%
%    ButtonName = questdlgchckbox(Question, Title, 'No')
%
...
%
%    ButtonName = questdlgchckbox(Question, Title, Btn1, Btn2, DEFAULT);
%
...
%
%    ButtonName = questdlgchckbox(Question, Title, Btn1, Btn2, OPTIONS);
%
...
%  Example:
%
%  ButtonName = questdlgchckbox('What is your favorite color?', ...
%                        'Color Question', ...
