function preAllocateTileBuffer(obj) %TODO: non-square images
    ...
    downsampleRatio = obj.downsamplePixPerLine / scnSet.pixelsPerLine;
    downsampledLinesPerFrame = round(scnSet.linesPerFrame * downsampleRatio);

    obj.downSampledTileBuffer = zeros(downsampledLinesPerFrame, ...
        obj.downsamplePixPerLine, ...
        numPlanes, ...
        maxChans, ...
        'int16');
