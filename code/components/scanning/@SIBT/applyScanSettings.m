function applyScanSettings(obj,scanSettings)
    ...
    %
    % Also See
    % SIBT.returnScanSettings, SIBT.doScanSettingsMatchRecipe
    ...
    if obj.versionGreaterThan('2020.1')
        for ii=1:length(scanSettings.powerZAdjustType)
            obj.hC.hBeams.pzAdjust(ii) = scanSettings.powerZAdjustType{ii};
        end
    else
